...
class ChartManager {
    ...
    setLanguage(language) {
        ...
        this.chart.options.plugins.title.text = isPolish ? 'HISTORIA SALDA' : 'BALANCE HISTORY';
        this.chart.options.scales.x.title.text = isPolish ? 'Data' : 'Date';
        this.chart.options.scales.y.title.text = isPolish ? `Saldo (${currencyCode})` : `Balance (${currencyCode})`;
