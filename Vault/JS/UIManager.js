class UIManager {
    ...
    initializeElements() {
        ...
        this.deleteTransactionModal = document.getElementById('deleteTransactionModal');
        this.confirmDeleteBtn = document.getElementById('confirmDelete');
        this.cancelDeleteBtn = document.getElementById('cancelDelete');
        this.confirmDeleteTransactionBtn = document.getElementById('confirmDeleteTransaction');
        this.cancelDeleteTransactionBtn = document.getElementById('cancelDeleteTransaction');
    }
    ...
    initializeEventListeners() {
        ...
        this.confirmDeleteBtn.addEventListener('click', () => this.deleteAllTransactions());
        this.cancelDeleteBtn.addEventListener('click', () => this.hideDeleteAllModal());
        this.confirmDeleteTransactionBtn.addEventListener('click', () => this.confirmDeleteTransaction());
        this.cancelDeleteTransactionBtn.addEventListener('click', () => this.hideDeleteTransactionModal());
    }
    ...
    addTransactionToDOM(transaction) {
        ...
        newTransactionElement.querySelector('.transaction-amount').appendChild(deleteButton);
    ...
    setLanguage(language) {
        ...
        document.querySelector('.income-area h3').textContent = language === 'pl' ? 'Przychód:' : 'Income:';
        document.querySelector('.expenses-area h3').textContent = language === 'pl' ? 'Wydatki:' : 'Expenses:';
        document.querySelector('.add-transaction').textContent = language === 'pl' ? 'Dodaj transakcję' : 'Add transaction';
        document.querySelector('.save').textContent = language === 'pl' ? 'Zapisz' : 'Save';
        document.querySelector('.cancel').textContent = language === 'pl' ? 'Anuluj' : 'Cancel';
        document.querySelector('.delete-all').textContent = language === 'pl' ? 'Usuń wszystko' : 'Delete All';
